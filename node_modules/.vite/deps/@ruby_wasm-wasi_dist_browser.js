  ...
  return {
    addToImports(imports) {
      ...
      wasiImport.fd_fdstat_get = (fd, fdstat) => {
        ...
        const RIGHTS_FD_WRITE2 = 1 << 6;
        view.setBigUint64(fs_rights_basePtr, BigInt(RIGHTS_FD_WRITE2), true);
        return 0;
      };
    },
    setMemory(m) {
...
var DefaultRubyVM = async (rubyModule, options = {}) => {
  var _a, _b;
  const args = [];
  ...
  const printer = ((_b = options.consolePrint) !== null && _b !== void 0 ? _b : true) ? consolePrinter() : void 0;
...
//# sourceMappingURL=@ruby_wasm-wasi_dist_browser.js.map
